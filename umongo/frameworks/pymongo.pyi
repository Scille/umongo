...
from ..document import DocumentImplementation as DocumentImplementation, DocumentTemplate
...
from ..instance import Instance as Instance, TDocImpl
...
from typing import Any, Optional, TypeVar, Dict, Type, Collection, Iterator
import abc

SESSION: Any

class BaseWrappedCursor(Collection[TDocImpl], metaclass=abc.ABCMeta):
    def __init__(self, document_cls, cursor, *args, **kwargs) -> None: ...
    def __getattr__(self, name): ...
    def __setattr__(self, name, value): ...
    def __getitem__(self, index: int) -> TDocImpl: ...
    def __next__(self) -> TDocImpl: ...
    def __iter__(self) -> Iterator[TDocImpl]: ...

# FIXME real WrappedCursor inherits from pymongo.cursor.Cursor.
# There might be some missing attributes
class WrappedCursor(BaseWrappedCursor[TDocImpl]):
...
class PyMongoDocument(DocumentImplementation):
    ...
    @classmethod
    def find_one(cls: Type[TDocImpl], filter: Optional[Dict[str, Any]] = ..., *args, **kwargs) -> Optional[TDocImpl]: ...
    @classmethod
    def find(cls: Type[TDocImpl], filter: Optional[Dict[str, Any]] = ..., *args, **kwargs) -> WrappedCursor[TDocImpl]: ...
    @classmethod
...
class PyMongoInstance(Instance[PyMongoDocument]):
